...
public class TC009NgKHPL {
  ...
  @Test
  public void testTC009NgKHPL() throws Exception {
    ...
    driver.findElement(By.id("ContentPlaceHolder1_txtTaiKhoan")).sendKeys("abcjaweoiu");
    driver.findElement(By.id("ContentPlaceHolder1_txtMatKhau")).clear();
    driver.findElement(By.id("ContentPlaceHolder1_txtMatKhau")).sendKeys("hăhiewajh");
    driver.findElement(By.id("ContentPlaceHolder1_txtHoTen")).clear();
    driver.findElement(By.id("ContentPlaceHolder1_txtHoTen")).sendKeys("jahtwin");
    ...
    driver.findElement(By.id("ContentPlaceHolder1_txtEmail")).click();
    driver.findElement(By.id("ContentPlaceHolder1_txtEmail")).clear();
    driver.findElement(By.id("ContentPlaceHolder1_txtEmail")).sendKeys("tungthinh23@gmail.");
    driver.findElement(By.id("ContentPlaceHolder1_txtDiaChi")).click();
