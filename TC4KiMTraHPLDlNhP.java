...
public class TC4KiMTraHPLDlNhP {
  ...
  @Test
  public void testTC4KiMTraHPLDlNhP() throws Exception {
    ...
    driver.findElement(By.id("ContentPlaceHolder1_txtTaiKhoan")).sendKeys("thinh");
    driver.findElement(By.id("ContentPlaceHolder1_txtMatKhau")).clear();
    driver.findElement(By.id("ContentPlaceHolder1_txtMatKhau")).sendKeys("thinh");
    ...
    driver.findElement(By.id("ContentPlaceHolder1_txtNamSinh")).sendKeys("2025-12-04");
