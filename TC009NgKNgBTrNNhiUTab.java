...
public class TC009NgKNgBTrNNhiUTab {
  ...
  @Test
  public void testTC009NgKNgBTrNNhiUTab() throws Exception {
    ...
    driver.findElement(By.id("ContentPlaceHolder1_txtTaiKhoan")).sendKeys("athwabdabn");
    driver.findElement(By.id("ContentPlaceHolder1_txtMatKhau")).clear();
    driver.findElement(By.id("ContentPlaceHolder1_txtMatKhau")).sendKeys("adwhaj");
