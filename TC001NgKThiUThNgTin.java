...
public class TC001NgKThiUThNgTin {
  ...
  @Test
  public void testTC001NgKThiUThNgTin() throws Exception {
    ...
    driver.findElement(By.id("ContentPlaceHolder1_txtTaiKhoan")).sendKeys("Phamduc");
    ...
    driver.findElement(By.id("ContentPlaceHolder1_txtMatKhau")).sendKeys("Tungthinh2002@");
    driver.findElement(By.id("ContentPlaceHolder1_txtHoTen")).click();
    driver.findElement(By.id("ContentPlaceHolder1_txtHoTen")).clear();
    driver.findElement(By.id("ContentPlaceHolder1_txtHoTen")).sendKeys("đằge");
    ...
    driver.findElement(By.id("ContentPlaceHolder1_txtNamSinh")).sendKeys("2025-12-12");
    ...
    driver.findElement(By.id("ContentPlaceHolder1_txtSdt")).sendKeys("dwadw");
